...
Copy-Item "./appsettings.json.TestServer" "./appsettings.json"
dotnet publish --configuration Release
scp -i D:\D-GakuWkSp\sshkey\laoshanghai_test -r D:\D-GakuWkSp\projects\103_cloudmenu-laoshanghai\cloudmenu-source\cloudmenu-api\bin\Release\net5.0\publish\* root@192.168.1.18:/home/cloudmenu/api
"sudo systemctl restart cloudmenu_api.service"
ssh laoshanghai_test "sudo systemctl restart cloudmenu_api.service"
"Invoke-WebRequest -Uri 'http://lsh.leadingwin.net/api/lab/getDbVersion'"